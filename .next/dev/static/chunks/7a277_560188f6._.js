...
"[project]/financeiro/node_modules/zoid/dist/zoid.frameworks.frame.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
}("undefined" != typeof self ? self : /*TURBOPACK member replacement*/ __turbopack_context__.e, function() {
    return function(modules) {
        ...
        function(module1, __webpack_exports__, __webpack_require__) {
            ...
            function getAllFramesInWindow(win) {
                ...
                var result = [].concat(getAllChildFrames(top), [
                    top
                ]);
                -1 === result.indexOf(win) && (result = [].concat(result, [
                    win
                ], getAllChildFrames(win)));
                return result;
            }
            var iframeWindows = [];
            var iframeFrames = [];
            ...
            function base64encode(str) {
                ...
                if ("undefined" != typeof __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"]) return __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(str, "utf8").toString("base64");
            ...
            function extend(obj, source) {
                ...
                if ("TURBOPACK compile-time truthy", 1) return Object.assign(obj, source);
            ...
            var util_ExtendableError = function(_Error) {
                ...
                function ExtendableError(message) {
                    ...
                    "function" == typeof Error.captureStackTrace ? Error.captureStackTrace(function(self1) {
            ...
            function getSerializedWindow(winPromise, _ref) {
                ...
                var windowTypePromise = winPromise.then(function(window1) {
                    ...
                    return getOpener(window1) ? WINDOW_TYPE.POPUP : WINDOW_TYPE.IFRAME;
                });
                ...
                return inlineMemoize(parseChildWindowName, function() {
                    ...
                    try {
                        return JSON.parse(function(str) {
                            ...
                            if ("undefined" != typeof __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"]) return __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(str, "base64").toString("utf8");
            ...
            function parentComponent(options, overrides, parentWin) {
                ...
                var focus = function() {
                    return promise_ZalgoPromise.try(function() {
                        if (currentProxyWin) return promise_ZalgoPromise.all([
                        ...
                        return promise_ZalgoPromise.try(function() {
                            ...
                            var buildUrlPromise = (function(propsDef, props) {
                                ...
                                return promise_ZalgoPromise.all(keys.map(function(key) {
                                    ...
                                    if (prop) return promise_ZalgoPromise.resolve().then(function() {
                                        ...
                                        if (null != value) return promise_ZalgoPromise.all([
                            ...
                            var buildWindowNamePromise = getProxyWindowPromise.then(function(proxyWin) {
                                return (function(_temp) {
                                    var _ref4 = void 0 === _temp ? {} : _temp, proxyWin = _ref4.proxyWin, childDomain = _ref4.childDomain, domain = _ref4.domain, context = (void 0 === _ref4.target && window, _ref4.context), uid = _ref4.uid;
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/loader/css/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/loader/html/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$loader$2f$css$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/loader/css/index.js [app-client] (ecmascript)");
;
const loaderComponentHtml = ({ nonce, text })=>`
        <div class='preloader spinner'>
            <style ${nonce ? `nonce="${nonce}"` : ''}>
              ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$loader$2f$css$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoaderCSS"])()}
            </style>
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/modal/css/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
`; //# sourceMappingURL=data:application/json;base64,
}),
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/modal/html/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/cordova.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "isRunningInCordova",
    ()=>isRunningInCordova,
    "openInCordovaInAppBrowser",
    ()=>openInCordovaInAppBrowser
]);
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/oauth.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "openOauthUrlInCordovaBrowser",
    ()=>openOauthUrlInCordovaBrowser
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/cordova.js [app-client] (ecmascript)");
;
function openOauthUrlInCordovaBrowser(url, onComplete) {
    const inAppBrowserWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openInCordovaInAppBrowser"])(url, '_blank');
    ...
    inAppBrowserWindow === null || inAppBrowserWindow === void 0 ? void 0 : inAppBrowserWindow.addEventListener('loadstop', (event)=>{
        const { url } = event;
        const isPluggyOauthCallbackUrl = (url.startsWith('https://api.pluggy.ai/') || url.startsWith('https://api.pluggy.dev/') || url.startsWith('http://localhost:9090/')) && url.includes('/oauthCallback.html');
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/once.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/props.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function adaptPluggyConnectProps(props) {
    ...
    return Object.assign(Object.assign({}, adaptedPropsBase), {
        onErrorProp: onError,
...
function restorePluggyConnectProps(adaptedProps) {
    ...
    // starting from props without the unneeded ones,
    // adding the ones we need.
    return Object.assign(Object.assign({}, adaptedProps), {
        onError: onErrorProp,
...
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/version.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getSdkVersion() {
    ...
    return sdkVersion;
} //# sourceMappingURL=data:application/json;base64,
}),
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/pluggy-connect.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$zoid$2f$dist$2f$zoid$2e$frameworks$2e$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/zoid/dist/zoid.frameworks.frame.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$loader$2f$css$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/loader/css/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$loader$2f$html$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/loader/html/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$modal$2f$css$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/modal/css/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$modal$2f$html$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/components/modal/html/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/cordova.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$oauth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/oauth.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$once$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/once.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$props$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/utils/props.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/version.js [app-client] (ecmascript)");
...
function initialize() {
    if (!zoidComponentInstance) {
        zoidComponentInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$zoid$2f$dist$2f$zoid$2e$frameworks$2e$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])({
            ...
            props: {
                ...
                sdkVersion: {
                    type: 'array',
                    required: false,
                    default: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSdkVersion"])()
                },
                _runningInCordova: {
                    type: 'boolean',
                    required: false,
                    default: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRunningInCordova"])()
                },
                forceOauthInBrowser: {
                    type: 'boolean',
                    required: false
            ...
            prerenderTemplate ({ doc, props }) {
                ...
                htmlNew.innerHTML = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$loader$2f$html$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loaderComponentHtml"])({
            ...
            containerTemplate ({ doc, dimensions: { height, width }, close, uid, frame, prerenderFrame, event, props }) {
                ...
                container.id = uid;
                container.innerHTML = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$modal$2f$html$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModalWrapper"])(uid, connectTheme);
                ...
                style.innerHTML = [
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$modal$2f$css$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCSS"])({
                        uid,
                        themeColor: 'fafafa',
                        height,
                        width,
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$components$2f$loader$2f$css$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getContainerCss"])({
                        uid
                    })
                ].join('\n');
                ...
                event.on(__TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$zoid$2f$dist$2f$zoid$2e$frameworks$2e$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT"].RENDERED, ()=>{
                ...
                event.on(__TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$zoid$2f$dist$2f$zoid$2e$frameworks$2e$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT"].DISPLAY, ()=>{
                ...
                const onClosePropWrapper = props.onCloseProp ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$once$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["once"])(props.onCloseProp) : null;
                event.on(__TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$zoid$2f$dist$2f$zoid$2e$frameworks$2e$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT"].CLOSE, ()=>{
                ...
                window.addEventListener('message', (event)=>{
                    ...
                    if (pluggyConnectMessage.type === 'OAUTH_OPEN' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRunningInCordova"])()) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$oauth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openOauthUrlInCordovaBrowser"])(oauthUrl, (payload)=>{
                            var _a;
                            return (_a = frame.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage(payload, '*');
                        });
                        return;
                    }
                    if (pluggyConnectMessage.type === 'LINK_OPEN' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRunningInCordova"])()) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$cordova$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openInCordovaInAppBrowser"])(externalUrl, '_system');
                        return;
                    }
...
class PluggyConnect {
    constructor(props){
        ...
        const extendedProps = Object.assign(Object.assign({}, props), {
            sdkVersion: (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSdkVersion"])()
        });
        // adapt props to avoid collision with Zoid component props
        // assign to private variable for reusability by React wrapper
        this.componentPropsExtendedAdapted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$utils$2f$props$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adaptPluggyConnectProps"])(extendedProps);
    }
    /**
     ...
     */ destroy() {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$zoid$2f$dist$2f$zoid$2e$frameworks$2e$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["destroy"])();
    }
    /**
...
const __TURBOPACK__default__export__ = PluggyConnect;
 //# sourceMappingURL=data:application/json;base64,
}),
"[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$pluggy$2d$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/pluggy-connect.js [app-client] (ecmascript)"); //# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiaW5kZXguanMiLCJzb3VyY2VSb290IjoiIiwic291cmNlcyI6WyIuLi8uLi9zcmMvaW5kZXgudHMiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUEsT0FBTyxFQUNMLGFBQWEsR0FJZCxNQUFNLGtCQUFrQixDQUFDIn0=
;
}),
"[project]/financeiro/node_modules/react-pluggy-connect/dist/module/version.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
 //# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoidmVyc2lvbi5qcyIsInNvdXJjZVJvb3QiOiIiLCJzb3VyY2VzIjpbIi4uLy4uL3NyYy92ZXJzaW9uLnRzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQU1BLCtDQUErQztBQUMvQyw4RkFBOEY7QUFDOUYsaUZBQWlGO0FBQ2pGLE1BQU0sQ0FBQyxrQ0FBa0MsR0FBRyxPQUFPLENBQUMifQ==
}),
"[project]/financeiro/node_modules/react-pluggy-connect/dist/module/react-pluggy-connect.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$pluggy$2d$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/pluggy-connect-sdk/dist/module/pluggy-connect.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$react$2d$pluggy$2d$connect$2f$dist$2f$module$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/react-pluggy-connect/dist/module/version.js [app-client] (ecmascript)");
;
;
;
const PluggyConnect = (props)=>{
    // wrap props as ref, to avoid re-render when the actual object reference changes
    const propsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(props);
    const pluggyConnectContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PluggyConnect.useCallback[pluggyConnectContainerRef]": (containerElement)=>{
            ...
            const pluggyConnect = new __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$pluggy$2d$connect$2d$sdk$2f$dist$2f$module$2f$pluggy$2d$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluggyConnect"](currentProps);
            pluggyConnect.init(containerElement).then({
                "PluggyConnect.useCallback[pluggyConnectContainerRef]": ()=>{
            ...
            }["PluggyConnect.useCallback[pluggyConnectContainerRef]"]).catch({
                "PluggyConnect.useCallback[pluggyConnectContainerRef]": (error)=>{
                    onLoadError === null || onLoadError === void 0 ? void 0 : onLoadError(error);
                }
            }["PluggyConnect.useCallback[pluggyConnectContainerRef]"]);
        }
    }["PluggyConnect.useCallback[pluggyConnectContainerRef]"], []);
    return __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        id: 'PluggyConnect',
        ref: pluggyConnectContainerRef
    });
...
"[project]/financeiro/node_modules/react-pluggy-connect/dist/module/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$react$2d$pluggy$2d$connect$2f$dist$2f$module$2f$react$2d$pluggy$2d$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/react-pluggy-connect/dist/module/react-pluggy-connect.js [app-client] (ecmascript)"); //# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiaW5kZXguanMiLCJzb3VyY2VSb290IjoiIiwic291cmNlcyI6WyIuLi8uLi9zcmMvaW5kZXgudHMiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUEsT0FBTyxFQUdMLGFBQWEsR0FJZCxNQUFNLHdCQUF3QixDQUFDIn0=
;
}),
"[project]/financeiro/node_modules/react-pluggy-connect/dist/module/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "PluggyConnect",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$react$2d$pluggy$2d$connect$2f$dist$2f$module$2f$react$2d$pluggy$2d$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluggyConnect"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$react$2d$pluggy$2d$connect$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/financeiro/node_modules/react-pluggy-connect/dist/module/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$financeiro$2f$node_modules$2f$react$2d$pluggy$2d$connect$2f$dist$2f$module$2f$react$2d$pluggy$2d$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/financeiro/node_modules/react-pluggy-connect/dist/module/react-pluggy-connect.js [app-client] (ecmascript)");
}),
"[project]/financeiro/node_modules/react-pluggy-connect/dist/module/index.js [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/financeiro/node_modules/react-pluggy-connect/dist/module/index.js [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=7a277_560188f6._.js.map